    ...
    <main className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      ...
      <header className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-100/80 dark:bg-zinc-900/60">
        <div className="mx-auto max-w-4xl px-4 py-6">
          ...
          <div className="mt-3 flex flex-wrap gap-2 text-xs">
            <span className="rounded bg-zinc-200 dark:bg-zinc-800 px-2 py-1">総供給: {HMC.supply} HMC(固定)</span>
            <span className="rounded bg-zinc-200 dark:bg-zinc-800 px-2 py-1">フェアローンチ</span>
            <span className="rounded bg-emerald-900/60 px-2 py-1 text-emerald-300">renounce済み(増刷不可)</span>
            <a href={HMC.solscan} target="_blank" rel="noopener noreferrer" className="rounded bg-zinc-200 dark:bg-zinc-800 px-2 py-1 hover:bg-zinc-300 dark:hover:bg-zinc-700">
              Solscanで見る ↗
            </a>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 space-y-10">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <a href="/kuji" className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/40 p-4 hover:border-amber-600 transition-colors">
            <p className="font-semibold">🎰 ヒカマくじ</p>
            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">{GAME.lotteryCost} HMCで抽選・当選で{GAME.lotteryWin} HMC</p>
          </a>
          <a href="/vote" className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/40 p-4 hover:border-sky-600 transition-colors">
            <p className="font-semibold">🗳 予想投票</p>
            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">界隈の出来事を予想して50 HMCで投票</p>
          </a>
          <a href="/baccarat" className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/40 p-4 hover:border-fuchsia-600 transition-colors">
            <p className="font-semibold">🃏 バカラ</p>
            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">50 HMC〜・プレイヤー/バンカー/タイ</p>
          </a>
        </div>
        ...
        <Panel title="📊 トークン配分(全アドレス公開)">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800/60">
                <tr>
                  ...
                  <td className="py-2 font-mono text-xs text-zinc-600 dark:text-zinc-400">{HMC.wallets.reward}</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4">運営リザーブ</td>
                  <td className="py-2 pr-4 text-sky-300">200,000,000 HMC (20%)</td>
                  <td className="py-2 font-mono text-xs text-zinc-600 dark:text-zinc-400">{HMC.wallets.ops}</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4">エアドロップ</td>
                  <td className="py-2 pr-4 text-amber-300">300,000,000 HMC (30%)</td>
                  <td className="py-2 font-mono text-xs text-zinc-600 dark:text-zinc-400">{HMC.wallets.airdrop}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/50 p-3">
            <p className="mb-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400">🔄 オンチェーン実残高</p>
            <OnchainPanel />
          </div>
        </Panel>
                ...
                <tr key={p.item} className={p.available ? "" : "opacity-50"}>
                  ...
                  <td className="py-2 text-right">
                    {p.available ? (
                      ...
                      <span className="rounded bg-zinc-200 dark:bg-zinc-800 px-2 py-0.5 text-xs text-zinc-600 dark:text-zinc-500">準備中</span>
                    )}
                  </td>
                </tr>
              ))}
        ...
        <footer className="border-t border-zinc-200 dark:border-zinc-800 pt-6 pb-10 text-center text-xs text-zinc-600">
          <p>Hikamani Coin (HMC) - ヒカマニ・ヒカマー界隈のコミュニティトークン</p>
          <p className="mt-1">
            投資勧誘ではありません / 公式リポジトリ:{" "}
            <a href="https://github.com/maebahesioru/hikamani-token" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:underline">
...
function Panel({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/40 p-5">
